...
/********************************************************************************
* display_init: Initierar hårdvara för 7-segmentsdisplayer. Dessutom initieras
...
*                Först återställs timerkretsarna och displayerna släcks. 
*                Sedan sätts samtliga filglobala variabler till startvärdena.
********************************************************************************/
...
*                         I praktiken kollar vi om avbrott är på timer_digit
*                         via funktionen timer_interrupt_enabled och returnerar
*                         detta direkt.
********************************************************************************/
...
*                        I praktiken kontrolleras om avbrott är aktiverat
*                        på timer_count_speed.
********************************************************************************/
...
/********************************************************************************
* display_enable_output: Sätter på 7-segmentsdisplayer, vilket i praktiken
*                        sker genom att vi aktiverar avbrott på timer_digit.
*                        Då kommer displayerna skiftas en gång per ms.
********************************************************************************/
...
*                         timer_digit, vilket innebär att den både stängs av
*                         samt att dess räknare nollställs. Sedan släcks
*                         displayerna.
********************************************************************************/
...
*                        Om displayerna är på släcks de, annars tänds de.
********************************************************************************/
...
*
*                     För att beräkna tiotalet så divideras talet i fråga med
*                     talbasen, exempelvis 74 / 10 = 7 (med heltalsdivision).
*
...
*                       kontinuerligt.
*
*                       1. Räkna upp timer_digit.
*                       2. När timer_digit har löpt ut (efter 1 ms) ska
*                          aktiv display skiftas, annars görs ingenting.
********************************************************************************/
